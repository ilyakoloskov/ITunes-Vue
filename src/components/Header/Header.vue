<template>
  <header class="header">
    ...
    <div class="header__track bg-secondary header-inner">
      <div v-if="IS_PLAYING" class="header__track-track">
        <div
          id="track-cover"
      ...
      <div v-else class="header__track-slot">
        <svg  width="30px" viewBox="0 0 256 315" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
          <g>
...
export default {
  ...
  computed: {
    ...mapGetters(["IS_PLAYING", "IS_SELECTED", "IS_AUDIO", "IS_AUDIO_VOLUME"]),
  },
  methods: {
    ...mapActions(["SET_PLAYING", "PLAY_TRACK", "NEXT_TRACK", "PREV_TRACK", "UPDATE_VOLUME"]),
  },
};
</script>
